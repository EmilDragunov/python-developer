# Generated by Django 3.2 on 2024-10-09 07:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('user', 'user'), ('moderator', 'moderator'), ('admin', 'admin')], default='user', max_length=50, verbose_name='Роль пользователя')),
                ('confirmation_code', models.SlugField(blank=True, null=True, verbose_name='Код подтверждения')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='genre',
            index=models.Index(fields=['slug'], name='genre_slug_unique_idx'),
        ),
        migrations.AddField(
            model_name='comment',
            name='author',
        ...
        migrations.AddIndex(
            model_name='category',
            index=models.Index(fields=['slug'], name='category_slug_unique_idx'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
